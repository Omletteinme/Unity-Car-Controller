...
public class WheelSkid : MonoBehaviour {
	...
	const float SKID_FX_SPEED = 10000; // Min side slip speed in m/s to start showing a skid
	const float MAX_SKID_INTENSITY = 10000.0f; // m/s where skid opacity is at full intensity
